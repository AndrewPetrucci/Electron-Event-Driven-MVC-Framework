...
export const STRUDEL_DOCS = {
    ...
    choose: { summary: 'Choose randomly from a list of elements, e.g. .s(choose("sine", "triangle", "bd:6")).', link: 'https://strudel.cc/learn/random-modifiers/#choose' },
    wchoose: { summary: 'Weighted choose: pick by probability, e.g. wchoose(["sine",10], ["triangle",1]).', link: 'https://strudel.cc/learn/random-modifiers/#wchoose' },
    ...
    wchooseCycles: { summary: 'Weighted pick per cycle. Synonym: wrandcat.', link: 'https://strudel.cc/learn/random-modifiers/#wchoosecycles' },
    wrandcat: { summary: 'Synonym for wchooseCycles.', link: 'https://strudel.cc/learn/random-modifiers/#wchoosecycles' },
    degradeBy: { summary: 'Randomly remove events: 0 = 0%, 1 = 100%. Amount between 0 and 1.', link: 'https://strudel.cc/learn/random-modifiers/#degradeby' },
    degrade: { summary: 'Randomly remove 50% of events. Shorthand for .degradeBy(0.5).', link: 'https://strudel.cc/learn/random-modifiers/#degrade' },
    undegradeBy: { summary: 'Inverse of degradeBy: 0 = 100% removal, 1 = 0%. Complements degradeBy.', link: 'https://strudel.cc/learn/random-modifiers/#undegradeby' },
    undegrade: { summary: 'Inverse of degrade: 50% kept (the ones degrade would remove). Shorthand for .undegradeBy(0.5).', link: 'https://strudel.cc/learn/random-modifiers/#undegrade' },
    sometimesBy: { summary: 'Apply a function with given probability (0–1). Similar to someCyclesBy.', link: 'https://strudel.cc/learn/random-modifiers/#sometimesby' },
    sometimes: { summary: 'Apply a function with 50% chance. Shorthand for .sometimesBy(0.5, fn).', link: 'https://strudel.cc/learn/random-modifiers/#sometimes' },
    someCyclesBy: { summary: 'Apply a function with given probability on a cycle-by-cycle basis.', link: 'https://strudel.cc/learn/random-modifiers/#somecyclesby' },
    someCycles: { summary: 'Apply a function 50% of cycles. Shorthand for .someCyclesBy(0.5, fn).', link: 'https://strudel.cc/learn/random-modifiers/#somecycles' },
    often: { summary: 'Apply a function with 75% chance. Shorthand for .sometimesBy(0.75, fn).', link: 'https://strudel.cc/learn/random-modifiers/#often' },
    rarely: { summary: 'Apply a function with 25% chance. Shorthand for .sometimesBy(0.25, fn).', link: 'https://strudel.cc/learn/random-modifiers/#rarely' },
    almostNever: { summary: 'Apply a function with 10% chance. Shorthand for .sometimesBy(0.1, fn).', link: 'https://strudel.cc/learn/random-modifiers/#almostnever' },
    almostAlways: { summary: 'Apply a function with 90% chance. Shorthand for .sometimesBy(0.9, fn).', link: 'https://strudel.cc/learn/random-modifiers/#almostalways' },
    never: { summary: 'Never apply the function. Shorthand for .sometimesBy(0, fn).', link: 'https://strudel.cc/learn/random-modifiers/#never' },
    always: { summary: 'Always apply the function. Shorthand for .sometimesBy(1, fn).', link: 'https://strudel.cc/learn/random-modifiers/#always' },
